export const jobExperienceData = [
  {
    ...
    learnt: [
      "Revamped a web project, migrating it from React 15 to React 18 with TypeScript. Implemented new features to enhance user experience and ensure high performance",
      "Implemented the transition of an app project from a native development framework to Flutter, improving cross-platform capabilities and user interaction",
      "Revamped a web project, converting it from React JS to Solid JS, enhancing code efficiency and user interface responsiveness",
    ],
